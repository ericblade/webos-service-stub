...
// TODO: hey, there's two different sources of activityCounter, one here, one in ActivityManager
// stub. what gives?
    ...
    this.activityManager = activityManager || {
        create: (activityName, callback) => {
            ...
            const emitter = this.subscribe('luna://com.webos.service.activitymanager/create', {
                activity: {
                    name: `${activityName}${activityCounter}`,
                    description: `activity created for ${activityName}${activityCounter}`,
                    type: {
                        foreground: true,
                        persist: false,
                        explicit: true,
